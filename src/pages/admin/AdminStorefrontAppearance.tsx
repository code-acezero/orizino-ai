    ...
    <div className="space-y-6 max-w-6xl">
      ...
      <section className="space-y-3">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
          {STOREFRONT_TYPOGRAPHY_PAIRS.map((p) => {
            ...
            return (
              ...
              >
                ...
                <div className="text-3xl leading-tight" style={{ fontFamily: p.heading }}>Aa</div>
    ...
    case "compact-grid":
      return (
        <div className={common + " grid grid-cols-4 gap-1"}>
          <div className={block} /><div className={block} /><div className={block} /><div className={block} />
        </div>
      );
    case "boutique":
      return (
